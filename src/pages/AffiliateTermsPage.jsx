import { AFFILIATE_TERMS as EN_TERMS } from '../content/en/affiliateTerms';
import { overlay as germanTerms } from '../content/de/affiliateTerms';
...
const OVERLAYS = { de: germanTerms.AFFILIATE_TERMS };
...
export default function AffiliateTermsPage() {
  const AFFILIATE = usePageContent(EN_TERMS, OVERLAYS);
