 ...
 * repeats the number.
 */
export default function FoundersBook({ id = 'founders' }) {
      ...
      <div className="site-shell">
        <div className="grid gap-12 lg:grid-cols-[1fr_0.85fr] lg:items-center lg:gap-16">
              ...
              {FOUNDERS.people.map((person) => (
                <li key={person.name} className="flex items-center gap-3">
                  ...
                  <span className="min-w-0">
                    ...
                    <span className="mt-0.5 block micro-label text-muted">{person.role}</span>
                  </span>
                </li>
              ))}
            </ul>
          ...
          <div data-reveal data-reveal-group="book-card" className="lg:justify-self-end">
            <div className="relative overflow-hidden rounded-3xl border border-ink-line bg-ink p-7 text-paper shadow-float sm:p-9">
