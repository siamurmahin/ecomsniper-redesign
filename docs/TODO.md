...
| Date        | What                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | Commit                                     |
| ----------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------ |
| 13 Sep 2026 | **The chatbot replaces Tawk, and loads on click.** Handed over as a `useEffect` appending the embed on every page — 13.3KB brotli, 61.9KB parsed, two new origins, an injected Google Fonts stylesheet, an 8s poll and an `EventSource`, all per page view. Built instead as a launcher this repo owns, so nothing third-party is fetched until it is pressed; eager JS unchanged at 597KB. The embed's font injection is suppressed by claiming the `#websychat-fonts` id it guards on. Tawk removed entirely. Its API sends no CORS headers, so the key is left unset — `ISSUES.md` 22                                     | `458f7ff`                                  |
