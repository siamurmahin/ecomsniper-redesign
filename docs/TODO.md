...
| 4 Sep 2026 | **Client deck spec.** `docs/CLIENT-DECK.md` — 20 slides, white ground and black text, one red accent, written as build instructions for Canva. Every figure measured; the file says so and forbids inventing any                                                                                                            | `PENDING4` |
